    ...
    <div className="container mt-5">
      <div className="card shadow-lg border-0 animate__animated animate__fadeInUp">
        <div className="card-header bg-primary text-white d-flex align-items-center justify-content-between">
          <h4 className="mb-0"><i className="bi bi-person-circle me-2"></i> Customer Profile</h4>
          <span className="badge bg-light text-dark">{profile.customerId}</span>
        </div>
        ...
        <div className="card-body">
          <section className="mb-4">
            ...
            <div className="row g-3">
              ...
              <div className="col-md-6"><strong>Gender:</strong> {profile.customerGender}</div>
          ...
          <section className="mb-4">
            ...
            <div className="row g-3">
              <div className="col-md-6"><strong>City:</strong> {profile.customerAddress?.city}</div>
              <div className="col-md-6"><strong>State:</strong> {profile.customerAddress?.state}</div>
              <div className="col-md-6"><strong>Country:</strong> {profile.customerAddress?.country}</div>
              <div className="col-md-6"><strong>Pincode:</strong> {profile.customerAddress?.pincode}</div>
            </div>
          </section>
