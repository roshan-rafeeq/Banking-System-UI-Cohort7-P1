  ...
  return (
    ...
    <div style={{ padding: '30px' }}>
      ...
      <div className="container py-4">
        <button className="btn btn-success rounded-pill px-4 mb-3">Ticket Status</button>
        ...
        <form style={{ maxWidth: '600px' }}>
          ...
          <div>
              <img
  src="/images/complaint.avif" // or any image URL
  alt="Ticket Status"
...
/>
      ...
      <div className="" style={{ display: 'flex', gap: '30px' }}>
        ...
        <div className="col-md-7">
          ...
          <div className="mb-3">
<a href="mailto:support@example.com?subject=Complaint&body=Dear Support," style={{ textDecoration: 'none' }}>
